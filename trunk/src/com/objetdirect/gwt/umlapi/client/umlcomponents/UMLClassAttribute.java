...
public class UMLClassAttribute {
     ...
     * 
     * @param attributeToParse The string containing an {@link UMLClassAttribute} obtained with {@link UMLClassAttribute#toString()}
     * 
     * @return The new parsed {@link UMLClassAttribute} or an empty one if there was a problem
     */
    public static UMLClassAttribute parseAttribute(String attributeToParse) {
     ...
     */
    public UMLClassAttribute(final UMLVisibility visibility, final String type,
	    final String name) {
	super();
