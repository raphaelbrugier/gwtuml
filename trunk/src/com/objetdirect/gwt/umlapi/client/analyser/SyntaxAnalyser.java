...
public abstract class SyntaxAnalyser {
	...
	public LexicalAnalyser.Token process(LexicalAnalyser lex, LexicalAnalyser.Token tk) {
	...
	protected abstract LexicalAnalyser.Token processToken(LexicalAnalyser lex, LexicalAnalyser.Token tk);
