...
class VirtualGroup extends IncubatorGfxObject {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.objetdirect.gwt.umlapi.client.gfx.canvas.objects.IncubatorGfxObject
	 * #addOnCanvasAt(com.objetdirect.gwt.umlapi.client.gfx.canvas.CanvasBridge, int, int)
	 */
	@Override
