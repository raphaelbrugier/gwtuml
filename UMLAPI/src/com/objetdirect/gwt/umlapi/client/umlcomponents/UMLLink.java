...
public abstract class UMLLink {
	...
	private LinkKind(final String name, 
	 ...
	 *  
	 * @param relationKindName The name of the {@link LinkKind} to retrieve
	 * @return The {@link LinkKind} that has relationKindName for name or null if not found
	 */
	public static LinkKind getRelationKindFromName(String relationKindName) {
	    for(LinkKind relationKind : LinkKind.values()) {
     ...
     *
     * @param linkKind The {@link LinkKind} of the {@link UMLLink}
     */
